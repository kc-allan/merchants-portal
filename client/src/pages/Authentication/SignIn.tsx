...
const SignIn: React.FC = () => {
  ...
  const { setUser, setLoginSuccess } = useAppContext();
    ...
    try {
      ...
      if (email && password) {
        const res = await axios.post(
          `${import.meta.env.VITE_SERVER_HEAD}/api/user/user/signin`,
          {
            email,
            password,
          },
        ...
        if (res && res.status === 200) {
          ...
          // Decode the token
          const decoded: any = jwt_decode(token_key);
          ...
          if (res.data.status === 200) setLoggedIn(res.data.message);
          setLoading(false);
        }
      } else {
        setLoading(false);
            ...
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form onSubmit={handleLogin}>
                <div className="mb-4">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-accent1 focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-accent1"
                ...
                {/* {message && (
                  <div className="mb-5">
                    <div
                      className={` w-full cursor-pointer rounded-lg border border-warning p-4 text-white transition hover:bg-opacity-20`}
                    ></div>
                  </div>
                )} */}
                ...
                <div className="mb-5">
                  <button
                    type="submit"
                    className="w-full cursor-pointer rounded-lg border border-accent1 bg-accent1 p-4 text-white transition hover:bg-opacity-90"
