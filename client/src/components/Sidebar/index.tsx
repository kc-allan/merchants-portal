...
// import brandMain from "../../images/brand/"
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col justify-between overflow-y-hidden bg-bodydark1 duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
      ...
      <div className="">
        ...
        <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
          ...
          <button
            ...
            className="block lg:hidden outline-none hover:bg-gray-400"
          >
            <svg
              stroke="none"
        ...
        {userRole !== '' && (
          <>
            <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
              {/* <!-- Sidebar Menu --> */}
              <nav className="mt-2 py-2 px-3 lg:px-6">
                <div>
                  <h3 className="uppercase  mb-4 ml-4 text-sm font-semibold text-warning">
                    My Dashboard
                  </h3>
                  {/* <!-- Menu Item Settings --> */}
                      ...
                      <>
                        <li>
                          ...
                          >
                            ...
                            >
                              <path
                                d="M4 6h16M4 6v12c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V6M4 6l1.5-3h13L20 6M8 11h8M8 15h5M6 21h12"
                                fill="none"
                                stroke="currentColor"
                                strokeWidth="2"
                                strokeLinecap="round"
                        ...
                        <li>
                          ...
                          >
                            ...
                            >
                              <path
                                d="M9 2h6a2 2 0 012 2v2h4a1 1 0 011 1v14a2 2 0 01-2 2H4a2 2 0 01-2-2V7a1 1 0 011-1h4V4a2 2 0 012-2zM9 10l2 2 4-4M9 2v2M15 2v2"
                                fill="none"
                                stroke="currentColor"
                                strokeWidth="2"
                                strokeLinecap="round"
            ...
            <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
              ...
              <nav className="mt-5 py-2 px-3 lg:mt-4 lg:px-6">
                <div>
                  {userRole == 'seller' && (
                    <>
                      <h3 className="uppercase mb-4 ml-4 text-sm font-semibold text-warning">
                        ...
                        <>
                          <li>
                            ...
                            >
                              ...
                              >
                                <path
                                  d="M3 7h18l-1 10c-.1 1.1-.9 2-2 2H6c-1.1 0-1.9-.9-2-2L3 7zM7 7V4a1 1 0 011-1h8a1 1 0 011 1v3M12 12v4M9 12v4M15 12v4"
                                  fill="none"
                                  stroke="currentColor"
                                  strokeWidth="2"
                                  strokeLinecap="round"
